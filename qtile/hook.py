...
def groups(): return [
    Group('1', label="I", layout="monadtall"),
    Group('2', label="II", layout="monadtall"),
    Group('3', label="III", layout="monadtall"),
    Group('4', label="IV", layout="monadtall"),
    Group('5', label="V", layout="monadtall"),
    Group('6', label="VI", layout="monadtall"),
]
